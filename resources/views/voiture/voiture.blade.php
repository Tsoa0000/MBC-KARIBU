...
<main id="main" class="main">
          ...
          <table class="table voiture-table align-middle mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $v["typeVehi"] }}</td>
                <td>
                  <span class="badge bg-{{ $v['etat'] >= 7 ? 'success' : ($v['etat'] >= 4 ? 'warning' : 'danger') }}">
                    {{ $v['etat'] }}/10
                  </span>
                </td>
                <td>{{ $v["conso"] }}</td>
                ...
                <td class="text-center">
                    <a href="#" class="action-btn btn-edit me-2"
                ...
                @empty
            <tr><td colspan="4">Aucun trajet enregistré.</td></tr>
          @endforelse
  ...
  <!-- Modal -->
<div class="modal fade" id="modifierVoitureModal" tabindex="-1" aria-labelledby="modifierVoitureLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="number" name="etat" id="edit-etat" class="form-control" min="0" max="10" required>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="number" min="2" max="100" name="nbrPlace" id="edit-nbrPlace" class="form-control" required>
            </div>
          </div>

...
@section('style')
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" integrity="sha512-p6U8xEUtD2lVwrfxRlI5g6VZ2G3PVpuf58I6Wq+g0EyIbfz1m+8TC0vU8srr8RzE2y6iUq6v6YHdqzJCRAPUPA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<div class="container" id="container">
  ...
  <div class="form-container sign-in-container">
    ...
    <form action="{{ route('login') }}" method="POST" autocomplete="on">
      ...
      <div class="input-floating">
        ...
        <span class="toggle-password" data-target="password-login" title="Afficher / masquer le mot de passe" role="button" tabindex="0">
  ...
  <div class="form-container sign-up-container">
    ...
    <form action="{{ route('register') }}" method="POST" autocomplete="on">
      ...
      <div class="input-floating">
        <span class="input-icon"><i class="fas fa-lock"></i></span>
        <input type="password" name="password_confirmation" id="password-confirm-register" placeholder=" " required>
        <label for="password-confirm-register">Confirmer le mot de passe</label>
        <span class="toggle-password" data-target="password-confirm-register" title="Afficher / masquer le mot de passe" role="button" tabindex="0">
